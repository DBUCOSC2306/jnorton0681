...
//        System.out.println("");
        ...
        LinkedOrderedList LinkedOrdered = new LinkedOrderedList();
        System.out.println("Is the LinkedOrdered list empty? " + LinkedOrdered.isEmpty()); //test isEmpty() (True)
        int LinkedOrderedSize = LinkedOrdered.size(); //test size()
        LinkedOrdered.add(5); //test add()
//        LinkedOrdered.add(1); //test add()
//        LinkedOrdered.add(3); //test add()
//        LinkedOrderedSize = LinkedOrdered.size();
//        System.out.println("LinkedOrdered list new size: " + LinkedOrderedSize + ". Number of elements in list: " + LinkedOrdered.getCount());
//        //test first() and last() 
//        System.out.println("LinkedOrdered list first element: " + LinkedOrdered.first() + ". LinkedOrdered list last element: " + LinkedOrdered.last()); 
//        System.out.println("Current LinkedOrdered list: " + LinkedOrdered.toString()); //test toString()
//        LinkedOrdered.remove(3);//test remove()
//        LinkedOrdered.removeLast();//test removeLast()
//        LinkedOrdered.removeFirst();//test removeFirst()
//        LinkedOrderedSize = LinkedOrdered.size();
//        System.out.println("LinkedOrdered list new size: " + LinkedOrderedSize + ". Number of elements in list: " + LinkedOrdered.getCount());
//        System.out.println("Current LinkedOrdered list: " + LinkedOrdered.toString()); //test toString()
//        
